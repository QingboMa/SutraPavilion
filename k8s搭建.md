...
# 在woker节点执行，可以加入到k8s集群
kubeadm join 192.168.1.7:6443 --token 5gxsga.y59s1763xsp042im \
        --discovery-token-ca-cert-hash sha256:d7c3debba6522553df3202263a1097d4cf424bc530db8cbd7d9de74e12cf36bf 
```

### 配置网络集群

> 创建配置文件 kube-flannel.yml
